    ...
    async signIn({ user }) {
      ...
      if (rows.length === 0) {
        ...
        try {
          ...
          const urlAprobar = `https://admin.gestion360ia.com.ar/dashboard`;
              ...
              <div style="font-family:'Segoe UI',Arial,sans-serif;max-width:480px;margin:0 auto;background:#F0F2F5;padding:32px 16px;">
                <div style="background:#fff;border-radius:16px;overflow:hidden;border:1px solid #E5E7EB;">
                  ...
                  <div style="padding:28px 32px;">
                    ...
                    <h1 style="font-size:20px;font-weight:700;color:#1F2937;margin:0 0 16px;">
                      Alguien quiere ingresar al panel
                    </h1>

                    <div style="background:#F4F7FA;border:1px solid #E5E7EB;border-radius:12px;padding:18px 20px;margin-bottom:24px;">
                      <table style="width:100%;font-size:13px;border-collapse:collapse;">
                        <tr>
                          <td style="color:#9CA3AF;font-weight:600;padding:4px 0;width:100px;">Nombre</td>
                          <td style="color:#1F2937;font-weight:600;padding:4px 0;">${user.name}</td>
                        </tr>
                        <tr>
                          <td style="color:#9CA3AF;font-weight:600;padding:4px 0;">Email</td>
                          <td style="color:#1F2937;padding:4px 0;">${user.email}</td>
                        </tr>
                        <tr>
                          <td style="color:#9CA3AF;font-weight:600;padding:4px 0;">Estado</td>
                          <td style="padding:4px 0;"><span style="background:#FBF6EE;color:#92680A;border:1px solid #E8D5AF;border-radius:999px;font-size:11px;font-weight:600;padding:2px 10px;">Pendiente de aprobación</span></td>
                        </tr>
                      </table>
                    </div>

                    <div style="text-align:center;">
                      <a href="${urlAprobar}" style="display:inline-block;background:#506886;color:#fff;text-decoration:none;font-size:14px;font-weight:600;padding:13px 32px;border-radius:10px;">
                  ...
                  <div style="background:#F9FAFB;border-top:1px solid #F3F4F6;padding:16px 32px;text-align:center;">
                    <p style="font-size:12px;color:#9CA3AF;margin:0;line-height:1.6;">
                      ...
                      Accedé a Sistema → Usuarios para gestionar el acceso.
                    </p>
                  </div>
